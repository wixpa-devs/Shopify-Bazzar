...
const hero =
   "relative isolate overflow-hidden bg-[#f4fbf5] px-5 py-16 font-[var(--inter-font)] sm:px-8 sm:py-20 lg:px-12 lg:py-[92px]";
const heroPattern =
...
const heroInner =
   "mx-auto grid max-w-[1430px] items-center gap-12 lg:grid-cols-[minmax(0,0.88fr)_minmax(560px,1.12fr)] lg:gap-10";
...
const title =
   "max-w-[710px] text-[clamp(3.05rem,5.15vw,5.85rem)] font-black leading-[1.08] tracking-[-0.055em] text-[#060b08] max-[640px]:text-[clamp(2.45rem,12vw,3.55rem)]";
const titleAccent = "text-[#20a84a]";
const description =
   "mt-8 max-w-[690px] text-[clamp(1rem,1.23vw,1.28rem)] font-semibold leading-[1.72] text-[#5e6874] max-[640px]:mt-6";
const actions =
   "mt-11 flex flex-wrap items-center gap-5 max-[640px]:mt-8 max-[520px]:grid max-[520px]:grid-cols-1";
const primaryButton =
   "inline-flex h-[56px] min-w-[200px] items-center justify-center gap-3 rounded-[9px] bg-[#079537] px-7 text-[0.98rem] font-black text-white shadow-[0_16px_32px_rgba(7,149,55,0.25)] transition-all duration-200 hover:bg-[#087c31] hover:shadow-[0_20px_38px_rgba(7,149,55,0.3)]";
const secondaryButton =
   "inline-flex h-[56px] min-w-[210px] items-center justify-center gap-3 rounded-[9px] border border-[#e0e8e2] bg-white px-7 text-[0.98rem] font-black text-[#159447] shadow-[0_14px_30px_rgba(17,24,39,0.08)] transition-all duration-200 hover:border-[#9ddfac] hover:bg-[#f5fcf7]";
const trustRow =
...
const appsSection =
   "bg-white px-5 pb-14 pt-16 font-[var(--inter-font)] sm:px-8 sm:pb-16 sm:pt-20 lg:px-12 lg:pb-18 lg:pt-[88px]";
...
const appsTitle =
   "max-w-[780px] text-[clamp(2.2rem,3.35vw,3.7rem)] font-black leading-[1.08] tracking-[-0.052em] text-[#07100a]";
const appsProfileLink =
   "mt-5 inline-flex h-11 items-center justify-center gap-2 rounded-[8px] border border-[#e2e9e4] bg-white px-5 text-[0.82rem] font-black text-[#159447] shadow-[0_12px_26px_rgba(17,24,39,0.07)] transition-all duration-200 hover:border-[#a8dfb5] hover:bg-[#f7fcf8] hover:text-[#087c31] max-[720px]:mt-0";
const appsGrid = "grid gap-7 md:grid-cols-2 xl:grid-cols-6";
const appCard =
   "group flex min-h-[265px] flex-col rounded-[16px] border border-[#e1e9e4] bg-white p-7 shadow-[0_14px_34px_rgba(17,24,39,0.06)] transition-all duration-200 hover:border-[#b8dfc4] hover:shadow-[0_20px_44px_rgba(17,24,39,0.09)] md:col-span-1 xl:col-span-2";
const appCardWide = "xl:col-span-3";
const appTop = "grid grid-cols-[76px_minmax(0,1fr)] gap-5";
const appLogoFrame =
   "flex h-[76px] w-[76px] items-center justify-center overflow-hidden rounded-[14px] border border-[#edf2ef] bg-white shadow-[0_12px_24px_rgba(17,24,39,0.08)]";
...
const appButton =
   "mt-6 inline-flex h-11 w-full items-center justify-center gap-2 rounded-[8px] bg-[#079537] px-5 text-[0.82rem] font-black text-white shadow-[0_12px_24px_rgba(7,149,55,0.2)] transition-all duration-200 hover:bg-[#087c31] group-hover:shadow-[0_16px_30px_rgba(7,149,55,0.25)]";
const statsSection =
   "bg-white px-5 py-10 font-[var(--inter-font)] sm:px-8 sm:py-12 lg:px-12";
const statsShell =
   "mx-auto grid max-w-[1320px] overflow-hidden rounded-[16px] border border-[#e0e8e3] bg-[#fbfdfc] shadow-[0_14px_36px_rgba(17,37,23,0.06)] md:grid-cols-2 xl:grid-cols-4";
const statItem =
...
const statIcon =
   "grid h-13 w-13 place-items-center text-[#159447] max-[640px]:h-11 max-[640px]:w-11";
const statValue =
...
const finalBannerWrap =
   "bg-white px-0 pb-7 pt-6 sm:pb-8 sm:pt-7 lg:pb-10 lg:pt-8";
