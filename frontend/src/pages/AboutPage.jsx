...
const hero =
   "relative isolate overflow-hidden border-b border-[#e8f0eb] bg-[#f4fbf5] px-5 py-16 sm:py-20 lg:py-[84px]";
const heroPattern =
...
const title =
   "text-[clamp(3.5rem,7vw,6rem)] font-black leading-[0.98] tracking-[-0.055em] text-[#090d0b] font-[var(--inter-font)]";
const description =
   "mt-8 max-w-[760px] text-[clamp(1.08rem,1.45vw,1.62rem)] font-semibold leading-[1.55] tracking-[-0.015em] text-[#59636c] font-[var(--inter-font)] max-[640px]:mt-6";

const missionSection =
   "relative overflow-hidden border-b border-[#e8f0eb] bg-white px-5 py-20 sm:py-24 lg:py-[96px] font-[var(--inter-font)]";
const missionInner =
   "mx-auto grid max-w-[1320px] items-center gap-14 lg:grid-cols-[minmax(0,0.92fr)_minmax(440px,0.86fr)] lg:gap-24";
const missionContent = "max-w-[660px] max-[1024px]:max-w-none";
const missionEyebrow =
   "mb-8 block text-[0.9rem] font-black uppercase tracking-[0.12em] text-[#1fa34a] max-[640px]:mb-5";
const missionTitle =
   "max-w-[640px] text-[clamp(3rem,4.9vw,5.2rem)] font-black leading-[1.08] tracking-[-0.055em] text-[#060b08] max-[640px]:text-[clamp(2.45rem,11vw,3.4rem)]";
const missionAccent = "text-[#25b14e]";
const missionText =
   "mt-8 max-w-[620px] text-[clamp(1rem,1.16vw,1.22rem)] font-semibold leading-[1.72] text-[#5e6874] max-[640px]:mt-6";
const missionTextSecond = `${missionText} mt-7 max-[640px]:mt-5`;
const wixpaCard =
   "relative overflow-hidden rounded-[28px] border border-[#e2e8e4] bg-white px-14 py-12 shadow-[0_26px_70px_rgba(15,25,18,0.08)] max-[1180px]:px-10 max-[640px]:rounded-[22px] max-[640px]:px-6 max-[640px]:py-8";
...
const teamEyebrow =
   "mb-7 block text-[0.9rem] font-black uppercase tracking-[0.12em] text-[#1fa34a] max-[640px]:mb-5";
const ceoCard =
...
const ceoTitle =
   "text-[clamp(2.7rem,4.6vw,5rem)] font-black leading-[1.04] tracking-[-0.055em] text-[#070b09] max-[640px]:text-[clamp(2.25rem,10vw,3.2rem)]";
const rolePill =
   "mt-5 inline-flex w-fit rounded-[8px] border border-[#bddfc8] bg-[#eef9f1] px-4 py-2 text-[1rem] font-black leading-none text-[#16793a] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.65)]";
const ceoCopy =
...
const memberCard =
   "rounded-[22px] border border-[#e3eae5] bg-white p-8 shadow-[0_18px_44px_rgba(17,37,23,0.055)] max-[640px]:p-6";
const memberHeader =
...
const memberRole =
   "inline-flex rounded-[8px] border border-[#bddfc8] bg-[#edf8f1] px-3.5 py-2 text-[0.86rem] font-black leading-none text-[#226f3b]";
const memberCopy =
...
const socialLink =
   "grid h-11 w-11 place-items-center rounded-[8px] border border-[#e2e9e4] bg-white text-[#070b09] shadow-[0_8px_20px_rgba(17,37,23,0.045)] transition-all duration-200 hover:-translate-y-0.5 hover:border-[#afdcbc] hover:text-[#15933e]";
...
const glanceSection =
   "border-b border-[#e8f0eb] bg-white px-5 pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-[96px] lg:pb-[72px] font-[var(--inter-font)]";
...
const aboutCta =
   "relative mt-12 grid min-h-[236px] overflow-hidden rounded-[24px] border border-[#293330] bg-[#070d0a] px-8 py-10 shadow-[0_22px_54px_rgba(9,14,11,0.18)] sm:px-12 lg:grid-cols-[minmax(0,0.9fr)_minmax(430px,0.82fr)_190px] lg:items-center lg:gap-8 lg:px-14";
const aboutCtaGrain =
