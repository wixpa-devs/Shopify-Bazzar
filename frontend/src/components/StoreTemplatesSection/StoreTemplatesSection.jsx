...
const title =
   "text-[28px] font-black leading-tight tracking-[-0.035em] text-[#111815] sm:text-[36px] lg:text-[40px]";
const subtitle =
...
const card =
   "group relative overflow-hidden rounded-[18px] border border-[#e1e8e3] bg-white shadow-[0_14px_34px_rgba(18,28,22,0.07)] transition duration-300 hover:border-[#bddbc6] hover:shadow-[0_22px_48px_rgba(18,28,22,0.11)]";
const image =
   "block aspect-[1402/1122] h-auto w-full select-none object-cover";
const overlay =
   "absolute inset-0 flex translate-y-0 flex-col justify-end bg-[linear-gradient(0deg,rgba(5,9,7,0.92)_0%,rgba(5,9,7,0.62)_42%,rgba(5,9,7,0.1)_76%,rgba(5,9,7,0)_100%)] p-4 opacity-100 transition duration-300 sm:p-5 md:translate-y-4 md:opacity-0 md:group-hover:translate-y-0 md:group-hover:opacity-100";
const cardTitle =
