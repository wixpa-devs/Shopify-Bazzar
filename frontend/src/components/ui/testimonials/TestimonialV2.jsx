export function getTestimonialV2Code(config = {}) {
  ...
  const subheadingText =
    ...
    "Over 3 million people trust DigitalBank with their everyday finances.";
  ...
  const card1Quote =
    config.card1Quote ||
    "I opened my account in literally 4 minutes. The virtual card was ready immediately — I used it online the same day. Absolutely seamless.";
  const card1Img =
    config.card1Img ||
  ...
  const card2Quote =
    config.card2Quote ||
    "The real-time FX rates saved me hundreds in international payments last year. The fee transparency is something traditional banks never offered me.";
  const card2Img =
    config.card2Img ||
  ...
  const card3Quote =
    config.card3Quote ||
    "Switched from my old bank after 10 years. The budgeting tools and instant notifications have completely changed how I manage my money.";
  const card3Img =
    config.card3Img ||
...
<style>
  ...
  .tv2-badge i {
    font-size: 24px;
    color: ${badgeTextColor};
    /* no font-family here – let Font Awesome keep its own */
  }
...
<section class="tv2-section">
  ...
  <div class="tv2-grid">
    <div class="tv2-card">
      ...
      <div class="tv2-author">
        ...
        <div>
          <div class="tv2-name">${card1Name}</div>
          <div class="tv2-role">${card1Role}</div>
        </div>
      </div>
    </div>
    <div class="tv2-card">
      ...
      <div class="tv2-author">
        ...
        <div>
          <div class="tv2-name">${card2Name}</div>
          <div class="tv2-role">${card2Role}</div>
        </div>
      </div>
    </div>
    <div class="tv2-card">
      ...
      <div class="tv2-author">
        ...
        <div>
          <div class="tv2-name">${card3Name}</div>
          <div class="tv2-role">${card3Role}</div>
        </div>
      </div>
    </div>
  </div>
  <div class="tv2-badges">
    <a href="${appStoreUrl}" class="tv2-badge">
      ...
      <div>
        <div class="tv2-badge-label">${appStoreLabel}</div>
        <div class="tv2-badge-title">${appStoreTitle}</div>
      </div>
    </a>
    <a href="${googlePlayUrl}" class="tv2-badge">
      <i class="fab fa-google-play"></i>
      <div>
        <div class="tv2-badge-label">${googlePlayLabel}</div>
        <div class="tv2-badge-title">${googlePlayTitle}</div>
      </div>
    </a>
  </div>
</section>
